...
void parse_qdimacs_file(std::string filename, cls_t& dcnf_fml, cls_t& dep_set,
                        ...
                        coord_t& dependency_var, coord_t s_level, coord_t& min_dep_size,
                        coord_t& max_dep_size);

void set_all_solutions(std::vector<Clauses>& dcnf_clauses, std::vector<Variables>& dcnf_variables, sel_bf& selected_bf, minsat_ass& minsat_clause_assgmt,
