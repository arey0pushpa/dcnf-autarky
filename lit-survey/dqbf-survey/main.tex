...
\section{Dependency}
\todo{Only read overview of the paper}The work by~\cite{wimmer2016dependency} analyse the dependency
...
dependency schemes.
%
\todo{Incomplete and not read the paper}Core of the paper is the method that gives rise to soundness results across different calculi... 
